...
[MODVERSION]: 1.1.1.0-release
[KSPVERSION]: 1.12.2

## Download on [Curseforge][CURSFG:url] or [Github][GITHUB:url] or [SpaceDock][SPCDCK:url]. 

##### Available on [CKAN][CKAN:url] as _`JackOLantern`._

# Jack-O'Lantern (JACK) 

Jack-O'Lantern themed probe cores in seven sizes. All the modcons. Now with pumpkin chunking!

#### By [`@zer0Kerbal`][LINK:zer0Kerbal] originally by [Porkjet][LINK:porkjet]

[![Mod Version][MOD:shd:latest]][MOD:url] [![KSP version][KSP:shd]][KSP:url]  [![License CC-BY-NC-4.0][LIC:shd]][LIC:url]  
...
- [x]  [Hallowe'en (HWLN)][thread:HLWN]  Trick'r'Treat!
...
- [x]  [SimpleLife! (SLIF!)][thread:SLIF] 
- [x]  [Comprehensive Kerbal Archive Network (CKAN)][CKAN:url] [^3]  

#### Mods that benefit Jack-O'Lantern (JACK) by [`zed'K`][LINK:zer0Kerbal] 
...
> License: [![License CC-BY-NC-4.0][LIC:shd]][LIC:url]  

> *** All bundled mods are distributed under their own licenses ***  
> *** All art assets (textures, models, animations, sounds) are distributed under their own licenses ***   

#### Original (0) - Author: [@`Porkjet`][LINK:porkjet]

> [Thread][MOD:org:thread]  - [Download][MOD:org:download] - Source: [GitHub][MOD:org:source] 
> License: [![License CC-BY-NC-4.0][LIC:org:shd]][LIC:org:url] 
...
![Hero Image][IMG:hero:1] 

###### v1.1.1.0 original: 01 Oct 2018 zed'K | updated: 24 Oct 2021 zed'K

<!-- mod links -->

[MOD:attr]: https://raw.githubusercontent.com/zer0Kerbal/JackOLantern/master/Attribution.md "Attributions"
[MOD:chlog]: https://github.com/zer0Kerbal/JackOLantern/Changelog.cfg "Changelog"
[MOD:contr]: https://github.com/zer0Kerbal/JackOLantern/blob/master/.github/CONTRIBUTING.md "Contributing"
[MOD:discu]: https://github.com/zer0Kerbal/JackOLantern/discussions "Discussions"
[MOD:issue]:  https://github.com/zer0Kerbal/JackOLantern/wiki/Known-Issues "GitHub Issues"
[MOD:known]: https://github.com/zer0Kerbal/JackOLantern/wiki/Known-Issues "Known Issues"
[MOD:licns]: https://github.com/zer0Kerbal/JackOLantern/blob/master/LICENSE "Github License"
[MOD:local]: https://github.com/zer0Kerbal/JackOLantern/blob/master/GameData/JackOLantern/Localization/readme.md "Localization"
[MOD:url]: https://forum.kerbalspaceprogram.com/index.php?/topic/189466-* "Halloween Forum Thread"
[MOD:wiki]: https://github.com/zer0Kerbal/JackOLantern/ "Wiki"

<!--- mod -->
[MOD:shd:latest]: https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/zer0Kerbal/JackOLantern/master/json/mod.json

[CODE:shd]: https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/zer0Kerbal/JackOLantern/master/json/code.json

<!--- release links -->
[CKAN:img]: https://i.postimg.cc/x8XSVg4R/sj507JC.png "CKAN"
[CKAN:url]: https://forum.kerbalspaceprogram.com/index.php?/topic/154922-* "CKAN"  
[CKAN:shd]: https://img.shields.io/badge/CKAN-JackOLantern-white.svg?style=plastic&labelColor=E32811 "CKAN"  

<!--- original mod -->
[MOD:org:source]: https://www.curseforge.com/kerbal/ksp-mods/JackOLantern "CurseForge"
[MOD:org:thread]: https://forum.kerbalspaceprogram.com/index.php?/topic/88595-* "Original Thread"
[MOD:org:download]: https://www.curseforge.com/kerbal/ksp-mods/JackOLantern "CurseForge"
...
<!--- misc logos -->
[IMG:flg:0]: https://raw.githubusercontent.com/zer0Kerbal/JackOLantern/master/img/JackOLantern0_icon.png "Jack-O'Lantern"

[IMG:hero:0]: https://i.imgur.com/6Dvavcc.jpg "BoOo!"
[IMG:hero:1]: https://i.imgur.com/gWlegrN.jpg "Meet the Family!"

<!-- financial support -->
[PAYPAL:img]: https://img.shields.io/badge/Buy%20me%20some%20-BoOo!-BADA55?style=for-the-badge&logo=paypal&labelColor=FFDD00 "PayPal"
[PAYPAL:url]: https://www.paypal.com/donate?hosted_button_id=R9ACWD7VREBCY "PayPal"

[PATREON:img]: https://img.shields.io/badge/Patreon-Trick'rTreat!-FF424D?style=for-the-badge&logo=patreon "Patreon"
